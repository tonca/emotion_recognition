...
for x in participants:
    ...
    for sessions in glob.glob("%s\\*" %x): #Store list of sessions for current participant
        ...
        print(vid_name)
        bashCommand = "C:\\Users\\dask\\Downloads\\ffmpeg-20171111-3af2bf0-win64-static\\bin\\ffmpeg -start_number 0 -i {}\\{}%02d.png -vcodec mpeg4 C:\\emotion_recognition\\data\\ckplus_vids\\{}.avi".format(sessions,vid_name[:15],vid_name[:17])
