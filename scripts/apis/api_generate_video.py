...
df = pd.read_csv('./o_csv/out_video.csv', sep=',', index_col='id', dtype={'img_name': str})
...
img = mpimg.imread('./video/in/001.jpg')
...
def do_calculation(i, filename):
    ...
    plt.savefig('./video/out/' + str(i) + '.jpg')
    return i

if __name__ == '__main__':
    multiprocessing.log_to_stderr(logging.DEBUG)
    print(api_data.img_name.dtype)
    frames = api_data.img_name + '.jpg'
